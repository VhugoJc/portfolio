  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div 
        ...
        className="absolute inset-0 opacity-10 md:opacity-20 transform transition-transform duration-75"
        style={{ transform: `translateY(${offset}px)` }}
      >
        <div className="absolute top-1/4 left-1/4 w-48 h-48 md:w-72 md:h-72 bg-primary-600 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute top-1/2 right-1/4 w-64 h-64 md:w-96 md:h-96 bg-cyan-600 rounded-full blur-3xl animate-pulse animation-delay-1000"></div>
        <div className="absolute bottom-1/4 left-1/3 w-56 h-56 md:w-80 md:h-80 bg-purple-600 rounded-full blur-3xl animate-pulse animation-delay-500"></div>
      </div>
